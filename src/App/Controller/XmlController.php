...
class XmlController
{
    public function index(Application $app)
    {
        ...
        $numberAllotment = $doc->createElementNS($namespace, 'ans:numeroLote', $idAllotment);
        ...
        $registerANS = $doc->createElementNS($namespace, 'ans:registroANS', 417311);
        $headerGuide->appendChild($registerAns);

        $numberGuideProvider = $doc->createElementNS($namespace, 'ans:numeroGuiaPrestador', 12345678);
        ...
        $cardNumber = $doc->createElementNS($namespace, 'ans:numeroCarteira', 12345678);
        ...
        $beneficiaryName = $doc->createElementNS($namespace, 'ans:nomeBeneficiario', 'Leandro Martins da Silva');
        ...
        $codeProviderOperator = $doc->createElementNS($namespace, 'ans:codigoPrestadorNaOperadora', 12345678);
        $hiredRequester->appendChild($codeProviderOperator);

        $hiredName = $doc->createElementNS($namespace, 'ans:nomeContratado', 'MATER DEI');
